...
function append_Data(formData){
    if(districts==null){
        ...
        // updated_districts.push(districts);
        districts.push(formData);
...
function update(name){
    ...
    for(var j=0; j<districts.length; j++){
        ...
        console.log(updateData);
            ...
            district1[i].Active_cases=district1[i].Active_cases+updateData.Active_cases;
            ...
            window.location.href = "add_data.php?w1=" + myJSON;
                ...
                if(validate_update(updateData,AC,RC,D)){
                district2[i].Active_cases=district2[i].Active_cases+updateData.Active_cases;
